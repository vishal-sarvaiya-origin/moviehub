...
This is just a demo, so we will limit the size of the file uploaded to the server ( max file size: 2 megabytes ).
</div>
<div class="content">
...
<label class="input-field">
<input type="text" placeholder="Select from existing categories">
</label>
</div>
</div>
<div class="col-12">
...
<label class="input-field">
<input type="text" placeholder="Select from existing tags">
</label>
</div>
</div>
<div class="col-12">
...
CHANNELS
 ...
 <label class="input-field">
<input type="text" placeholder="Select from existing channels">
</label>
</div>
</div>
<div class="col-12">
...
<label class="input-field">
<input type="text" placeholder="Select from existing playlists">
</label>
</div>
</div>
</div>
